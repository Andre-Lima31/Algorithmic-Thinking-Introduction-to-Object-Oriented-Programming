...
while Valor_Calculado == True and Compra_Fechada == True and Parcela_Confirm == '2':
    print ('\t')
...
>'''))
    if csv_confirma == '2':
        ...
        parcelas = ["Numero da Parcela;", "Valor;", "Cliente;", "Referente a;", "Data de Vencimento;", "Pago;"]
        for i in range (0, Qnt_Parcela):
            i = i+1
            parcelas.append([str(i)+";", str(Valor_APagar)+";", str(usuario[0])+";", "R.M.;", str(data.strftime("%d/%m/%Y"))+";", "( );"],)
